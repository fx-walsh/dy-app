...
COPY page_images (page_id, img_file_name, publish_date, column_type, page_type, special_name, column_id)
FROM '/home/db-seed-data/page_images.csv'
DELIMITER ','
CSV HEADER;

COPY columns_meta_data (column_id, publish_date, column_type, special_name, first_img_file_name, column_title)
FROM '/home/db-seed-data/columns_meta_data.csv'
DELIMITER ','
CSV HEADER;
